...
def train_evaluate_lstm(X, y, num_folds=5, num_interpolations=3, epochs=150, batch_size=64):
    """
    Treina e avalia modelo LSTM usando validação cruzada estratificada.
    """
